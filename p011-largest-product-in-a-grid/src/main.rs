...
fn is_valid_position(r: i8, c: i8) -> bool {
    ...
    for r in 1..GRID_SIZE {
        for c in 1..GRID_SIZE {
            for &(dr, dc) in DIRECTIONS.iter() {
                ...
                for step in 0..4 {
                    let new_r: i8 = r + dr * step;
                    let new_c: i8 = c + dc * step;
                    ...
                    product *= grid[new_r as usize][new_c as usize];
                }

                if is_valid && product > max_product {
                    max_product = product
                }
            }
        }
